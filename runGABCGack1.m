...
%Employed2(i,Param2Change)=Employed(i,Param2Change)+(Employed(i,Param2Change)-Employed(neighbour,Param2Change))*(rand-0.5)*2+(GlobalParams(Param2Change)-Employed(i,Param2Change))*rand;   
if(GlobalParams(Param2Change)==Employed(i,Param2Change))
Employed2(i,Param2Change)=Employed(i,Param2Change)-abs(GlobalParams(Param2Change)-Employed(i,Param2Change))*rand*((Objsen(i,Param2Change)>0)-0.5)*2;    
else
  if(GlobalParams(Param2Change)>Employed(i,Param2Change))    
Employed2(i,Param2Change)=Employed(i,Param2Change)+(GlobalParams(Param2Change)-Employed(i,Param2Change))*(1-rand*((SglobalMin(Param2Change)>0)*2-1))+(Employed(i,Param2Change)-Employed(neighbour,Param2Change))*(rand-0.5)*2;
%Employed2(i,Param2Change)=Employed(i,Param2Change)+(Employed(i,Param2Change)-Employed(neighbour,Param2Change))*(rand-0.5)*2+(GlobalParams(Param2Change)-Employed(i,Param2Change))*rand;
%Employed2(i,Param2Change)=Employed(i,Param2Change)+(Employed(i,Param2Change)-Employed(neighbour,Param2Change))*(rand-0.5)*2;
%Employed2(i,Param2Change)=Employed(i,Param2Change)+(GlobalParams(Param2Change)-Employed(i,Param2Change))*(1-rand*((SglobalMin(Param2Change)>0)*2-1));
  else
Employed2(i,Param2Change)=Employed(i,Param2Change)+(GlobalParams(Param2Change)-Employed(i,Param2Change))*(1+rand*((SglobalMin(Param2Change)>0)*2-1))+(Employed(i,Param2Change)-Employed(neighbour,Param2Change))*(rand-0.5)*2;  
  end;
end;

%(1-rand*(SglobalMin(Param2Change)>0));
%   Gradients provide the search direction      
         if (Employed2(i,Param2Change)<ABCOpts.lb)
             Employed2(i,Param2Change)=ABCOpts.lb;
         end;
...
ind=ind(end);
if (Bas(ind)>ABCOpts.Limit&&all(abs(Objsen(ind,:))<10*max(max(abs(SglobalMin)))))
